...
TextureROMSpec IntroImage8Texture =
{
	// charset spec
...
BgmapSpriteROMSpec IntroImage8Sprite =
{
	{
		// sprite's type
		__TYPE(BgmapSprite),
		...
		// texture spec
		(TextureSpec*)&IntroImage8Texture,
...
BgmapSpriteROMSpec* const IntroImage8Sprites[] =
{
	&IntroImage8Sprite,
	NULL
...
EntityROMSpec IntroImage8Entity =
{
	// class allocator
	__TYPE(Entity),
