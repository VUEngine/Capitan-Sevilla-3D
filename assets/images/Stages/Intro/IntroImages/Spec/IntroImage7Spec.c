...
TextureROMSpec INTRO_IMAGE_7_TX =
{
	// charset spec
...
BgmapSpriteROMSpec INTRO_IMAGE_7_SPRITE =
{
	{
		// sprite's type
		__TYPE(BgmapSprite),
...
BgmapSpriteROMSpec* const INTRO_IMAGE_7_SPRITES[] =
{
...
EntityROMSpec INTRO_IMAGE_7_IM =
{
	// class allocator
	__TYPE(Entity),
